...
## Project Structure
    ...
    ├── test_healthcheck_d_118356  # Django project configurations
...
1. Clone this repo and `cd test_healthcheck_d_118356`
...
2. Clone this repo and `cd test_healthcheck_d_118356`
